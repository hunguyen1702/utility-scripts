...
for f in __init__.py config_init.py slack_post_message.py slack_upload_file.py; do
...
cp "${TMP}/cmd_config_init.py" "${LIB_DIR}/utility_scripts_cli/commands/config_init.py"
